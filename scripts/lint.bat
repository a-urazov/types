...
if %ERRORLEVEL% NEQ 0 (
    ...
    powershell -Command "Invoke-WebRequest -Uri 'https://github.com/golangci/golangci-lint/releases/download/v2.6.2/golangci-lint-2.6.2-windows-amd64.zip' -OutFile 'golangci-lint.zip'"
